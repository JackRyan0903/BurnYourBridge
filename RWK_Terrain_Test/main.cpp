				   ...
				   PSTR cmdLine, int showCmd)
{
	...
	WalkTerrainDemo app(hInstance, "RYU_Terrain_Test", D3DDEVTYPE_HAL, D3DCREATE_HARDWARE_VERTEXPROCESSING);
	gd3dApp = &app;
...
void WalkTerrainDemo::drawScene()
{
	...
	HR(gd3dDevice->SetRenderState(D3DRS_FILLMODE, g_bWireframe ? D3DFILL_WIREFRAME : D3DFILL_SOLID));
